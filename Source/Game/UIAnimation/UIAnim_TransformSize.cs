...
[ContentContextMenu("New/UI/Animation/TransformSize")]
public class UIAnim_TransformSize : UIAnim_Base<Float2>
{
    ...
    {
        target.Control.Resize(ref value);
    }

    public override Float2 ReadCurrentValue(UIControl target)
    {
        return target.Control.Size;
    }
